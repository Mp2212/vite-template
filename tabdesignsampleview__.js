...
export default {
  data() {
    ...
    selectedButton: { label: 'Graph', value: 'Graph', disabled: false },
  ...
  computed: {
    ...
    return this.options.map(option => {
      ...
      return {
        label: labelMap[option] || option, // only label is changed
        value: option,                     // keep original value intact
...
.tab-shaped-btn.active {
  background-color: #012169;
  color: #fff; /* Dark text on active tab */
